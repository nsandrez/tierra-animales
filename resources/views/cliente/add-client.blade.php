...
@section('title', 'Dashboard - Registro de Cliente')

@section('contenido-admin')
    <h2 class="text-3xl font-semibold">Registro de Cliente</h2>
    <p class="text-lg text-muted-foreground">Por favor, complete la información para registrar un nuevo cliente.</p>
    <br>
