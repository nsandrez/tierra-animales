...
<body class="bg-white flex items-center justify-center h-screen">
    <div class="text-center">
        ...
        <h1 class="text-4xl font-bold text-gray-800 mt-4">Página no encontrada</h1>
        <p class="mt-2 text-gray-500 max-w-md mx-auto">Lo sentimos, pero la página que estás buscando no existe.</p>
        <a href="/"
